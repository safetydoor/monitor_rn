...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        if(CURRENT_VERSION>=7.0){
            frame = CGRectMake(frame.origin.x, frame.origin.y+18, frame.size.width, frame.size.height-20);
        }
        ...
        backButton.frame = CGRectMake(frame.origin.x+20, frame.origin.y+10, 21, 27);
        
        UIImage *backButtonImg = [UIImage imageNamed:@"ap_back"];
//        backButtonImg = [backButtonImg stretchableImageWithLeftCapWidth:backButtonImg.size.width*0.5 topCapHeight:backButtonImg.size.height*0.5];
        ...
        UIImage *backButtonImg_p = [UIImage imageNamed:@"ap_back_p"];
