...
- (void)viewForCell:(NSUInteger)cell inScroll:(NSUInteger)scroll reusingCell:(UITableViewCell *)tc {
    ...
    switch (scroll) {
        ...
        case 0:{
            ...
            tc.textLabel.text=[NSString stringWithFormat:@"%i %@",cell,NSLocalizedString(@"hour", nil)];
            break;
        }
        case 1:{
            
            tc.textLabel.text=[NSString stringWithFormat:@"%i %@",cell,NSLocalizedString(@"minute", nil)];
            break;
        }
